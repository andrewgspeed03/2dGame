...
void TiledRenderer::render(gl2d::Renderer2D &renderer)
    {
        ...
        //this allows us to see what the player can
    ...
    void renderSpaceShip(gl2d::Renderer2D &renderer, glm::vec2 position,
    float size, gl2d::Texture texture, glm::vec4 uvs, glm::vec2 viewDirection){
